...
export default function Toolbar() {
  ...
  function handleZoomIn() {
    setZoomLevel(Math.min(zoomLevel + 0.05, 1.0))
  }
  ...
  return (
    <div className="fixed z-50 bottom-5 left-0 right-0 w-fit mx-auto flex items-center justify-center">
      <div className="flex divide-x bg-white border shadow-lg rounded-lg">
        <StyledTooltip text="Zoom in">
          <button className="cursor-pointer p-4 hover:bg-gray-50 active:bg-gray-200" onClick={handleZoomIn}>
            <ZoomIn size={20} />
          </button>
        </StyledTooltip>
